...
B) Trottier: This folder extracts data from the Trottier data set and compares sectoral emissions in the classic, net-zero-by-2050 scenario with an accelerated, net-zero-by-2045 scenario. The graph generated by Jupyter notebook 'Trottier - Identifying Substitution.ipynb' is presented as the standalone image 'NZ45 vs NZ50 Emission Differentials in 2050.png'. and it is one of the subplots that can be found in *"1. Identifying Competition\Navius\2050\Navius Trottier Side-by-Side Subplots.ipynb"*.
